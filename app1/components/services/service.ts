 ...
 */
export function getNodeAttr(req: any) {
 ...
 * @param req 
 */
export function getWorkflowFlowData(req:any) {
    return api.get(config.WORK_FLOW_GRAPH, req);
}
 ...
 * @param req 
 */
export function approve(taskId: string, req: any) {
 ...
 * @param req 
 */
export function revoke(procInstId:string, req: any) {
