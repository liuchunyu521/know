...
export default {
  ...
  methods: {
    ...
    getData:function(res){
      ...
      _this.nodata = false;
      _this.page = 1;
      axios.get(serverUrl+"leave/leavelist",{params:res}).then(function(res){
    ...
    applyprocess:function(res){
      var _this = this;
      this.$router.push({name: 'applyprocess', params: {usercode:_this.usercode,pk_leave:res,fatherPage:"vacationlist"}})
    }
